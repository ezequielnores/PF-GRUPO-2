...
//                             <Item sx={{backgroundColor:"#D9D9D9", color:"#307196", fontWeight:"bold"}}>Surname:</Item>
//                             <Item sx={{marginLeft:3, color:"black"}}>{patientDetail?.surname} </Item>
//                         </div>
                        
//                         <div style={{display:"flex", flexDirection:"row"}}>
//                             <Item sx={{backgroundColor:"#D9D9D9", color:"#307196",fontWeight:"bold"}}>DNI:</Item>
//                             <Item sx={{marginLeft:3,color:"black"}}>{patientDetail?.dni} </Item>
//                         </div>
//                         <div style={{display:"flex", flexDirection:"row",}}>
//                             <Item sx={{backgroundColor:"#D9D9D9", color:"#307196",fontWeight:"bold"}}>Mail:</Item>
//                             <Item sx={{marginLeft:3,color:"black"}}>{patientDetail.mail} </Item>
//                         </div>
//                         <div style={{display:"flex", flexDirection:"row"}}>
//                             <Item sx={{backgroundColor:"#D9D9D9", color:"#307196",fontWeight:"bold"}}>Date:</Item>
//                             <Item sx={{marginLeft:3,color:"black"}}>{patientDetail?.birthday} </Item>
//                         </div>
//                         <div style={{display:"flex", flexDirection:"row"}}>
//                             <Item sx={{backgroundColor:"#D9D9D9", color:"#307196",fontWeight:"bold"}}>Weigth:</Item>
//                             <Item sx={{marginLeft:3,color:"black"}}>{patientDetail?.weight} </Item>
//                         </div>
//                         <div style={{display:"flex", flexDirection:"row"}}>
...
//                             <Item sx={{marginLeft:3,color:"black"}}>{patientDetail?.plan} </Item>
//                         </div>
//                 </Stack>
//                 <br></br>
//             </div>
      ...
      <Grid item xs={12} md={6} >
        <Paper elevation={3} >
          ...
          <Stack
                    ...
                    >
                        {patientDetail!==null? (
                        <Avatar alt="Remy Sharp" sx={{ width: 100, height: 100 }} src={patientDetail?.photo} />)
                    :
                    ...
                    <Divider/>
                        ...
                        <div style={{display:"flex", flexDirection:"row"}}>
                            <Item sx={{backgroundColor:"#D9D9D9", color:"#307196", fontWeight:"bold"}}>Name:</Item>
                            <Item sx={{marginLeft:3, color:"black"}}>{patientDetail?.name} </Item>
                        </div>
                        <div style={{display:"flex", flexDirection:"row"}}>
                            <Item sx={{backgroundColor:"#D9D9D9", color:"#307196", fontWeight:"bold"}}>Surname:</Item>
                            <Item sx={{marginLeft:3, color:"black"}}>{patientDetail?.surname} </Item>
