    ...
    return (
     ...
     <Card className={`${classes.card} ${plan.name == 'iCare full' ? classes.cardGold : plan.name == 'iCare simple' ? '' : classes.cardBlue}`}>
          ...
          <CardContent className={classes.cardContent}>
            ...
            <Button variant="contained" size="large" className={classes.buyButton} onClick={() => handleBuyPlan(plan)}>
            Obtain
            </Button>
            </CardActions>
            </Card>
            ...
            <div className={classes.cardActions} style={{marginTop:"10%"}}>
             ...
             <Button variant="contained" color="primary" component={Link} to="/subscriptions/history">
                 Cuurent plan
             </Button>
             </div>
            </div>
