...
import { Agenda, HomeMedic,MedicalEmergency,ProfileMedic,ReviewsMedic } from "../index"
...
export default function MiniDrawer() {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      {window.location.pathname === "/HomeMedic" &&
      ...
      {location.pathname.endsWith("HomeMedic/Agenda") &&
          <box>
      <Agenda />
      </box>}
