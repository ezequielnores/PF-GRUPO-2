...
const Profile = () => {
  ...
  return (
    <div style={padreDiv}>
      {!isActive && (
        <Typography fontSize="1rem" fontWeight="bold" style={warning}>
          We are reviewing your information, we will activate your account as
          soon as possible, thank you for joining our team.
        </Typography>
      )}
