        ...
        <Card style={carde}>
          <div style={{ marginLeft: "5px", marginRight: "5px" }}>
            ...
            <Typography variant="h6">
              Experts recommend drinking water before feeling thirsty to prevent
              dehydration during the summer With the arrival of summer and
              rising temperatures, it is important to pay attention to body
              hydration. Health experts recommend drinking water regularly, even
              before feeling thirsty, to prevent dehydration. Dehydration can
              have serious health consequences, especially for children, the
            ...
            <Typography style={{ fontSize: "17.5px" }}>
              ...
              <li>
                Avoid drinks with caffeine or alcohol, as they can contribute to
                dehydration.
              </li>
            ...
            <Typography variant="h6">
              ...
              dehydration and enjoy the summer season in a safe and healthy way.
            </Typography>
          </div>
        </Card>
      </div>
